...
.bb8__body {
  ...
  background:
    ...
    -o-linear-gradient(var(--bb8-bg) 4%, var(--accent) 4% 10%, transparent 10% 90%, var(--accent)
          90% 96%, var(--bb8-bg) 96%),
...
.bb8__body::before {
  ...
  background:
    -o-radial-gradient(center, 1em circle, rgb(236, 236, 236) 50%, transparent 51%),
...
.bb8-toggle__cloud:nth-last-child(1) {
  width: 0.875em;
  height: 0.625em;
  -webkit-filter: blur(0.125em) drop-shadow(0.313em 0.313em #ffffffae) drop-shadow(-0.625em 0 #fff)
  ...
  background: -webkit-gradient(linear, left bottom, right top, from(#ffffffae), to(#ffffffae));
...
.chenini {
  ...
  background: -webkit-gradient(linear, left top, left bottom, from(#fff), to(#6e8ea2));
...
.tatto-2 {
  ...
  background: -webkit-gradient(linear, left top, left bottom, from(#e6ac5c), to(#d75449));
