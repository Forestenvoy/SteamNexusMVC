<template>
  <CRow>
    ...
    <CCol xs="12" md="6" class="mb-5 mb-md-0 d-flex flex-column justify-content-center">
      <!-- 標題 -->
      <h3 class="title text-center">記憶體</h3>
      <!-- 圖片 -->
      <div class="d-flex justify-content-center align-items-center">
        <img src="@/assets/images/builder/ram.png" alt="RAM" class="image" />
      </div>
    </CCol>
    <!-- 右側 -->
    <CCol xs="12" md="6">
            ...
            <CRow>
              <CCol xs="5" class="d-flex justify-content-end align-items-center">
                <div class="form__group field">
                  <input type="number" class="form__field" placeholder="最低容量" v-model="smin" />
                  <label for="min" class="form__label">最低容量</label>
                </div>
              </CCol>
              ...
              <CCol xs="5" class="d-flex justify-content-start align-items-center">
                <div class="form__group field">
                  <input type="number" class="form__field" placeholder="最低容量" v-model="smax" />
                  <label for="max" class="form__label">最高容量</label>
                </div>
              </CCol>
            </CRow>
          </CForm>
